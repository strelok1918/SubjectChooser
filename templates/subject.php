...
<script type = "text/template" id = "subjectListItem">
	<li class="list-group-item" id = "subjectItem<%=id %>">
		...
		<div class = "pull-right">
			...
			<img src = "<?php echo Yii::app()->baseUrl; ?>/images/icons/edit.png" class = "subjectItemIcon" onclick = "location.href = '<?php echo Yii::app()->createAbsoluteUrl('site/editSubject') . "&id="; ?><%= id %>'">
